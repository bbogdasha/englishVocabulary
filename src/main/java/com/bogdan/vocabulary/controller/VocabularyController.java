...
public class VocabularyController {
    ...
    public ResponseEntity<PageSettingsDto<VocabularyDto>> getAllVocabularies(@Valid PageSettings pageSettings) {
        PageSettingsDto<VocabularyDto> vocabulariesDto = vocabularyService.getAllVocabularies(pageSettings);
    ...
    public ResponseEntity<VocabularyDto> patchVocabulary(@PathVariable Long vocabularyId, @RequestBody Map<String, Object> changes) {
        VocabularyDto patchVocabulary = vocabularyService.patchVocabulary(vocabularyId, changes);
